class TemplateListMixin:
    ...
    def get_template_name(self, model_name: str, app_label: str) -> str:
        if getattr(self, "template_name", None) and isinstance(
...
class TemplateCreateMixin:
    ...
    def get_template_name(self, model_name: str, app_label: str) -> str:
        ...
        return f"apps/{app_label}/{model_name}/create.html"
    ...
    def get_partial_template_name(self, model_name: str, app_label: str) -> str:
        ...
        return f"cotton/{app_label}/{model_name}/modal_create.html"
